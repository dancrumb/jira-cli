...
import JiraApi, { TransitionObject } from 'jira-client';
...
export default class JiraIssues {
  ...
  */
  createIssue( newIssue: JiraApi.IssueObject ) {
    // Create new issue
  ...
  */
  showIssues( issues: JiraApi.IssueObject[] ) {
  ...
  */
  showIssue( issue:JiraApi.IssueObject ) {
  ...
  */
  assignIssue( issue: string, user: string ) {
  ...
  * Get project issues
  */
  getProjectIssues( project: string ) {
    const _this = this;
  ...
  */
  async getIssueTransitions( issueId: string ): Promise<TransitionObject[] | void> {
    return jira.api.listTransitions( issueId )
      .then(function( res ) {
        let transitions: TransitionObject[] = [];
        const transitionObj: TransitionObject[] = res.transitions;
  ...
  */
  transitionIssue( issueId: string, transitionObj: TransitionObject ){
  ...
  */
  async makeTransition( issueId: string, transitionName: string ){
